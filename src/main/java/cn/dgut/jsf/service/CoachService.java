...
public interface CoachService {
    ...
    public int reduceMchRemainingQuantity(int member_id, int ch_id);//减少课时剩余
    ...
    public CoachAppoint findMaxTimeByCoachIdAndChId(int coach_id,  int ch_id, String time,int num );//发现该教练课时类型下的未来可预约的时间段
